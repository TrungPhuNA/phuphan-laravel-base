        ...
        <div class="container-fluid p-0">
            ...
            <div class="row mb-2 mb-xl-3">
                <div class="col-auto d-none d-sm-block">
                    <h3><strong>Thêm mới nhóm quyền</strong></h3>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="web" name="guard_name" value="{{ old("guard_name","web") }}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Description</label>
                                    <input type="description" class="form-control" placeholder="Mô tả" name="description" value="{{ old("description") }}" required>
