        ...
        <div class="container-fluid p-0">
            ...
            <div class="row mb-2 mb-xl-3">
                ...
                <div class="col-auto ms-auto text-end mt-n1">
                    <a href="{{ route("admin.blog.article.create") }}" class="btn btn-primary"><i class="align-middle" data-feather="plus"></i> Thêm mới</a>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                                ...
                                @foreach($articles ?? [] as $item)
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <a href="{{ route("admin.blog.article.delete", $item->id) }}" class="btn btn-sm btn-danger"><i class="align-middle" data-feather="trash"></i></a>
                                            <a href="{{ route("admin.blog.article.update", $item->id) }}" class="btn btn-sm btn-primary"><i class="align-middle" data-feather="edit"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
